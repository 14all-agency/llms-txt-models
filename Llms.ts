...
export const LlmsResult = z.object({
  ...
  deliveryMethod: z.string().nullable().optional().describe("How the main LLMS file is served"),
  themeAssetKey: z.string().nullable().optional().describe("Theme asset key for main LLMS file"),
...
export const LlmsModelSchema = z.object({
  ...
  deliveryMethod: LlmsResult.shape.deliveryMethod,
  themeAssetKey: LlmsResult.shape.themeAssetKey,
